  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5.justify-content-center.align-items-center
      .col-lg-9.mb-4.mb-lg-0
        p.mb-3(data-aos="fade-right") La segmentación permite que las empresas diseñen estrategias diferenciadas para grupos específicos de consumidores, aumentando la efectividad comercial y optimizando los recursos organizacionales. Cada segmento presenta necesidades, comportamientos y expectativas particulares que requieren propuestas de valor adaptadas (Malhotra, 2019).
      ...
      .col-12.col-lg-10(data-aos="zoom-in-right")
        .tarjeta-cita-fondo.p-4.p-lg-5
          .row.justify-content-end.align-items-center
            .col-lg-auto
              img(
                src='@/assets/curso/tema1/img31.png',
